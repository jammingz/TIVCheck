                ...
                if (gestureDetector.onTouchEvent(event)) {
                    ...
                    */
                    ...
                    if (isOverlayOn) {
                        ...
                        // If overlay isnt on, we start the OCR

                        // First we write Screenshot to SD file
                        Date now = new Date();
                        ...
                        try {
                            String mPath = Environment.getExternalStorageDirectory().toString() + "/TeamIVChecker/Screenshot" + now + ".jpg";
                        ...
                        ScreenshotEditor editor = new ScreenshotEditor(screenshot, display);
